...
- 207 个精选动作、稳定编号和约 35% 的辅助动作轮换
- 新动作中文步骤、同肌群单动作替换和推拉腿结构校验
- “不适”暂停推荐、“轻松”继续进阶或换变式，以及旧备份兼容

## 当前发布状态

- 阶段二已于 2026-09-03 发布并完成线上验收。
- 线上已启用 207 个精选动作、智能变式、中文动作步骤、反馈偏好与旧数据兼容。
...
当前检查会验证页面脚本、精选动作数据、中文步骤、旧动作迁移、四种时长、三类环境、轮换结构和 AI 候选边界。完整交互仍需按 [运行与发布手册](docs/runbook.md) 做浏览器冒烟测试。
